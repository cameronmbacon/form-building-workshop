...
articleView.create = function() {
  console.log('Someone done changed the damn form');
  ...
  console.log('WTF publishedOn: ', newArticle.publishedOn);

  // TODO: Use our interface (API?!?!?!?!) to the Handblebars template to put this new article into the DOM:
